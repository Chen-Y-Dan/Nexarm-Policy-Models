...
├── act_v3/         # ACT policy
├── act_v4/         # ACT policy (current, latest)
└── ...
```
...
| `act_v4` | ACT | Put object into box | 60 episodes, varied positions | [CypherChen/nexarm_act_v4](https://huggingface.co/CypherChen/nexarm_act_v4) |
